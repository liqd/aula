...
-- instance (ThrowSendMailError e, GetConfig r) => HasSendMail e r (
...
checkSendMail cfg = do
    ...
    r <- runExceptT (runReaderT (sendMailToAddress address msg :: ReaderT Config (ExceptT SendMailError IO) ()) cfg)
    case r of
