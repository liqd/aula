        ...
        div_ [class_ "ideas-list-item"] $ do
            ...
            -- FIXME use the phase
                div_ [class_ "col-8-12"] $ do
                    div_ [class_ "ideas-list-img-container"] nil
                -- FIXME only display image if it exists
                ...
                -- TODO: show how many votes are in and how many are required
                    ...
                    span_ [class_ "progress-bar"] $ do
                        -- TODO: make this a real percentage
                        span_ [class_ "progress-bar-progress", style_ "width: 67%"] nil
